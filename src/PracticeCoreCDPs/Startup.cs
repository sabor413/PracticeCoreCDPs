...
namespace PracticeCoreCDPs
{
    public class Startup
    {
        public Startup(IHostingEnvironment env)
        {
            ...
            AppSettings.Factory = Configuration.GetValue<string>("AppSettings:Factory");
            AppSettings.FactoryType = Configuration.GetValue<string>("AppSettings:FactoryType");
        }
